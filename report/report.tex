...
In our experiments, the use of the $\softmax$ Bellman operator resulted in much faster training convergence and higher test scores (see chapter \ref{chap:results}), thus replicating the claims made in the cited paper.
...
\begin{figure}[!h]
	...
	\caption{Input graph with GNN aggregation}
...
\section*{Standard vs. softmax Bellman}
...
\section*{FOV with multi-agent graph embeddings}

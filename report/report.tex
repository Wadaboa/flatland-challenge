...
Other experiments were made when training the DQN model using the binary tree observator: 
\begin{enumerate}
	...
	\item Training without giving an increasing penalty for agents choosing to consequently take a stop moving action was detrimental: agents learned to stop in order to completely avoid deadlocks

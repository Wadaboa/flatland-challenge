...
Following the reported reasoning, the following rewards shaping was perfomed:
\begin{itemize}
...
\[a_t = \left\{
\begin{array}{ll}
      \max Q_{\pi_t}(s,a) & \text{if } r \ge \epsilon \\
...
By tweaking a little bit the $\epsilon$-greedy selector we could also get two others selectors:
\begin{itemize}
	\item Greedy: set $\epsilon=0$ and avoid decaying it
	\item Random: set $\epsilon=1$ and avoid decaying it
\end{itemize}
